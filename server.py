...
PUNTOS_REFERENCIA = {
    ...
    'FARDARIAS': {
        ...
        'factor_dia': 6,
        'fuerza_modificador': 1,
        'descripcion': 'Sistema de periodización temporal basado en el ciclo de los 7 planetas tradicionales. Cada planeta rige un período de vida cuya duración se determina por su número asociado.'
    }
}
...
def calculate_forecasts():
    ...
    try:
        ...
        # Calcular fardarias independientemente del punto de referencia
        # (Siempre incluimos estos datos en el resultado)
        ...
        # sino que proporcionamos los datos de fardarias más detallados
        if punto_referencia == 'FARDARIAS':
            # No calculamos liberaciones específicas para fardarias
            liberaciones = []
            
            # Aquí podríamos añadir cálculos específicos para fardarias si son necesarios
            # Por ejemplo, "puntos de cambio" entre períodos de fardarias
            # Estos serían diferentes de las liberaciones normales
